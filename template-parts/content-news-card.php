...
<div class="max-md:w-[calc(50%-0.5rem)] <?php echo esc_attr($wrapper_class); ?> bg-neutral-50 rounded-lg inline-flex flex-col justify-start items-center overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-[1.03]" data-aos="fade-up" data-aos-delay="<?php echo esc_attr($delay); ?>">
    ...
    <div class="self-stretch p-2 flex flex-col justify-start  gap-2">
        <div class="self-stretch flex flex-col justify-start  gap-4">
            ...
            <?php if ($cat_name) : ?>
                <div class="h-6 w-fit px-2 bg-green-100 rounded-[100px] inline-flex justify-center items-center gap-2.5 self-start">
                    <div class="w-auto px-2 h-11 text-right text-neutral-950 text-xs font-normal capitalize leading-10">
