(() => {
  ...
  var { __ } = wp.i18n;
  var { useBlockProps, InspectorControls, MediaUpload, MediaUploadCheck, URLInput, InnerBlocks, PanelColorSettings, RichText } = wp.blockEditor;
  ...
  var GreenergyPostSelection = ({ selectedPosts, onChange, postType = "news" }) => {
  ...
  var GreenergyMenuSelect = ({ label, value, onChange }) => {
  ...
  var GreenergySocialLinksControl = ({ label, links, onChange }) => {
    ...
    return createElement(
      ...
      (links || []).map((link, index) => createElement(
        PanelBody,
        { key: index, title: link.platform || `\u0631\u0627\u0628\u0637 #${index + 1}`, initialOpen: false },
        createElement(TextControl, {
  ...
  var GreenergyNavLinksControl = ({ label, links, onChange }) => {
    return createElement(
      PanelBody,
      { title: label, initialOpen: false },
      (links || []).map((link, index) => createElement(
        PanelBody,
        { key: index, title: link.label || `\u0631\u0627\u0628\u0637 #${index + 1}`, initialOpen: false },
        createElement(TextControl, {
      ...
      switch (name) {
        ...
        case "greenergy/most-read-news":
          return createElement(
            ...
            createElement(
              PanelBody,
              { title: __("\u0623\u0639\u062F\u0627\u062F \u0627\u0644\u0623\u062E\u0628\u0627\u0631", "greenergy"), initialOpen: attributes.selectionMode === "auto" },
        ...
        case "greenergy/jobs":
          return createElement(
            ...
            createElement(
              PanelBody,
              { title: __("\u0631\u0648\u0627\u0628\u0637 \u0627\u0644\u0635\u0641\u062D\u0627\u062A", "greenergy"), initialOpen: false },
              createElement(
                "div",
                { style: { marginBottom: "15px" } },
        ...
        case "greenergy/all-jobs":
          return createElement(
            ...
            !attributes.showGoldOnly && createElement(
              PanelBody,
              { title: __('\u0631\u0627\u0628\u0637 "\u0627\u0643\u062A\u0634\u0641 \u0627\u0644\u0643\u0644"', "greenergy"), initialOpen: false },
              createElement(
                "div",
                { style: { marginBottom: "15px" } },
        ...
        case "greenergy/stats":
          return createElement(
            ...
            attributes.viewMode === "static" && createElement(
              ...
              (attributes.stats || []).map((stat, index) => createElement(
                PanelBody,
                { key: index, title: stat.title || `\u0625\u062D\u0635\u0627\u0626\u064A\u0629 #${index + 1}`, initialOpen: false },
                createElement(TextControl, {
        ...
        case "greenergy/main-banner":
          return createElement(
            ...
            (attributes.showStats || attributes.isJobsPage) && createElement(
              Fragment,
              null,
              createElement("hr", null),
              createElement("div", { style: { fontWeight: "bold", marginBottom: "10px" } }, __("\u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u0625\u062D\u0635\u0627\u0626\u064A\u0627\u062A", "greenergy")),
              (attributes.stats || []).map((stat, index) => createElement(
                "div",
                { key: index, style: { padding: "10px", border: "1px solid #eee", marginBottom: "10px", borderRadius: "8px" } },
                createElement(SelectControl, {
                ...
                stat.mode === "manual" || !stat.mode ? createElement(TextControl, {
                  label: __("\u0627\u0644\u0642\u064A\u0645\u0629", "greenergy"),
                  value: stat.value,
                  onChange: (v) => {
                    const newStats = [...attributes.stats];
                ...
                stat.iconType === "font-awesome" ? createElement(
                  Fragment,
                  null,
                  createElement(TextControl, {
        ...
        case "greenergy/header":
          return createElement(
            ...
            createElement(
              PanelBody,
              { title: __("\u0627\u0644\u0625\u0639\u0644\u0627\u0646\u0627\u062A", "greenergy"), initialOpen: false },
              ...
              (attributes.adRight?.adType === "image" || !attributes.adRight?.adType) && createElement(
                Fragment,
                null,
                createElement(GreenergyImageControl, {
              ...
              (attributes.adLeft?.adType === "image" || !attributes.adLeft?.adType) && createElement(
                Fragment,
                null,
                createElement(GreenergyImageControl, {
            ...
            createElement(
              PanelBody,
              { title: __("\u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0648\u0627\u0644\u0631\u0648\u0627\u0628\u0637", "greenergy"), initialOpen: false },
        ...
        case "greenergy/footer-widgets":
          return createElement(
            ...
            createElement(
              PanelBody,
              { title: __("\u0627\u0644\u0639\u0645\u0648\u062F \u0627\u0644\u0623\u0648\u0644", "greenergy"), initialOpen: false },
            ...
            createElement(
              PanelBody,
              { title: __("\u0627\u0644\u0639\u0645\u0648\u062F \u0627\u0644\u062B\u0627\u0646\u064A", "greenergy"), initialOpen: false },
            ...
            createElement(
              PanelBody,
              { title: __("\u0627\u0644\u0639\u0645\u0648\u062F \u0627\u0644\u062B\u0627\u0644\u062B", "greenergy"), initialOpen: false },
            ...
            createElement(
              PanelBody,
              { title: __("\u0627\u0644\u0639\u0645\u0648\u062F \u0627\u0644\u0631\u0627\u0628\u0639", "greenergy"), initialOpen: false },
  ...
  var blocks = [
    ...
    },
    {
      ...
      attributes: {
        copyrightText: {
          type: "string",
          default: __("\u0643\u0644 \u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0649 \xA9 Greenergy {year}", "greenergy")
        },
  ...
  var JobSectionEdit = (props) => {
    ...
    const TEMPLATES = {
      ...
      "list": [
        ...
        iconStrategy === "individual" ? ["core/list", { placeholder: __("\u0623\u0636\u0641 \u0642\u0627\u0626\u0645\u0629...", "greenergy") }, [
    ...
    return createElement(
      ...
      createElement(
        ...
        sectionType === "list" && createElement(
          PanelBody,
          { title: __("\u0625\u062F\u0627\u0631\u0629 \u0639\u0646\u0627\u0635\u0631 \u0627\u0644\u0642\u0627\u0626\u0645\u0629", "greenergy"), initialOpen: true },
          createElement(Button, {
            isPrimary: true,
            isLarge: true,
        ...
        createElement(
          PanelBody,
          { title: __("\u0625\u0636\u0627\u0641\u0629 \u0623\u0642\u0633\u0627\u0645 \u0633\u0631\u064A\u0639\u0629", "greenergy"), initialOpen: false },
          createElement(
            "div",
            ...
            ].map((btn, idx) => createElement(Button, {
              key: idx,
              isSecondary: true,
