(() => {
    ...
    document.addEventListener("click", function(e) {
      ...
      fetch(greenergyData.ajaxUrl, {
        ...
        if (data.success) {
          ...
          const paginationWrapper = container.querySelector(".js-ajax-pagination-wrapper") || container.querySelector(".pagination") || container.querySelector(".greenergy-pagination");
  ...
  // assets/js/src/modules/hub-nav.js
  function initHubNav() {
      ...
      fetch(url).then((response) => response.text()).then((html) => {
        ...
        if (newContent) {
          setTimeout(() => {
            ...
            history.pushState({ type }, doc.title, url);
  ...
  // assets/js/src/modules/company-overview.js
  ...
  function initGalleryLightbox() {
    ...
    triggers.forEach((trigger) => {
      ...
      trigger.addEventListener("click", function(e) {
        ...
        lightbox.onclick = (ev) => {
          if (ev.target === lightbox && !ev.target.closest(".swiper"))
            close();
        };
        document.addEventListener("keydown", function keydown(e2) {
          if (e2.key === "Escape") {
            close();
  ...
  // assets/js/src/modules/product-modal.js
  function initProductModal() {
    document.addEventListener("click", function(e) {
      ...
      if (downloadModalClose || downloadModalBackdrop) {
        ...
        if (!downloadModal || !downloadModal.id)
          return;
  ...
  // assets/js/src/modules/company-products-pagination.js
  function initCompanyProductsPagination() {
    document.addEventListener("click", function(e) {
      ...
      if (!grid || typeof greenergyData === "undefined" || !greenergyData.ajaxUrl || !greenergyData.nonce)
        return;
      if (loader) {
      ...
      fetch(greenergyData.ajaxUrl, {
        ...
        if (data.success && data.data) {
          ...
          if (paginationWrap && data.data.pagination !== void 0) {
  ...
  // assets/js/src/modules/all-companies-pagination.js
  function initAllCompaniesPagination() {
    document.addEventListener("click", function(e) {
  ...
  // assets/js/src/modules/all-orgs-pagination.js
  function initAllOrgsPagination() {
    ...
    function loadPage(block, page) {
      ...
      fetch(greenergyData.ajaxUrl, {
        ...
        if (data.success && data.data) {
          ...
          if (countEl && data.data.count_html !== void 0) {
    ...
    document.addEventListener("change", function(e) {
      if (!e.target.matches(".js-all-orgs-filter"))
        return;
  ...
  // assets/js/src/modules/all-projects-pagination.js
  function initAllProjectsPagination() {
    function getFormForBlock(block) {
      const blockId = block.id || block.getAttribute("data-block-id");
      if (blockId) {
    ...
    function loadPage(block, page) {
      ...
      if (form) {
        ...
        if (countryEl)
          country = countryEl.value || "";
        if (sortEl)
          sort = sortEl.value || "latest";
        if (sProjEl)
          sProj = (sProjEl.value || "").trim();
      }
      if (!grid || typeof greenergyData === "undefined" || !greenergyData.ajaxUrl || !greenergyData.nonce)
        return;
      if (gridContainer) {
    ...
    document.addEventListener("change", function(e) {
      if (!e.target.matches(".js-all-projects-filter"))
        return;
      const select = e.target;
      const group = select.closest(".group");
  ...
  // assets/js/src/modules/all-experts-pagination.js
  function initAllExpertsPagination() {
    function getFormForBlock(block) {
      const blockId = block.id || block.getAttribute("data-block-id");
      if (blockId) {
    ...
    document.addEventListener("change", function(e) {
      if (!e.target.matches(".js-all-experts-filter"))
        return;
      const select = e.target;
      const group = select.closest(".group");
    ...
    document.addEventListener("greenergy:experts-apply-search", function(e) {
      if (e.detail && e.detail.block)
        loadPage(e.detail.block, 1);
    });
  }

  // assets/js/src/modules/expert-filter-autocomplete.js
  function initExpertFilterAutocomplete() {
    ...
    wraps.forEach((wrap) => {
      ...
      function fetchSuggestions(q) {
        if (typeof greenergyData === "undefined" || !greenergyData.ajaxUrl)
          return;
        const params = new URLSearchParams({
          action: "greenergy_experts_search_suggest",
          term: q
        });
        fetch(greenergyData.ajaxUrl + "?" + params.toString(), { method: "GET" }).then((res) => res.json()).then((json) => {
  ...
  // assets/js/src/modules/company-filter-autocomplete.js
  function initCompanyFilterAutocomplete() {
